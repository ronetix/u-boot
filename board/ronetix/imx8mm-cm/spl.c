...
#define PC_SION (MUX_PAD_CTRL(I2C_PAD_CTRL) | MUX_MODE_SION)

#define I2C_PMIC	1

struct i2c_pads_info i2c_pad_info1 = {
	.scl = {
		.i2c_mode = IMX8MM_PAD_I2C2_SCL_I2C2_SCL | PC_SION,
		.gpio_mode = IMX8MM_PAD_I2C2_SCL_GPIO5_IO16 | PC,
		.gp = IMX_GPIO_NR(5, 16),
	},
	.sda = {
		.i2c_mode = IMX8MM_PAD_I2C2_SDA_I2C2_SDA | PC_SION,
...
#define USDHC2_PWR_GPIO IMX_GPIO_NR(2, 10)
...
void board_init_f(ulong dummy)
{
	...
	ret = mem_test(CFG_SYS_SDRAM_BASE, PHYS_SDRAM_SIZE, BLOCK_SIZE, TEST_SIZE);
	if (ret)
		hang();
